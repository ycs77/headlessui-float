// Reference: https://github.com/tailwindlabs/headlessui/blob/7794d563e181787e995db1f877cd26c460e385ee/packages/%40headlessui-vue/src/hooks/use-outside-click.ts
...
export function useOutsideClick(
  ...
  function handleOutsideClick<E extends MouseEvent | PointerEvent | FocusEvent>(
    ...
    for (const container of _containers) {
      ...
      const domNode = container instanceof HTMLElement ? container : dom(container)
